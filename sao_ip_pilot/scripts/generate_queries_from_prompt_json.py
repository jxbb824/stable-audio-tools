...
def parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--ckpt-path", type=str, default="sao_ip_pilot/outputs/models/0/model.ckpt")
    parser.add_argument("--prompt-json", type=str, default="sao_ip_pilot/outputs/prompts.json")
    parser.add_argument("--output-dir", type=str, default="sao_ip_pilot/outputs/generated_queries")
